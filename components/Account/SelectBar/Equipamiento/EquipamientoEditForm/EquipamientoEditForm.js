    ...
    <div className="EquipamientoEditForm">
      <div className="EquipamientoEditForm__form">
        ...
        >
            ...
            <Input className={`nombre ${editable ? "" : "disabled"}`}
            name="nombre"
            type="text"
            ...
            <Input className={`nombreequipo ${editable ? "" : "disabled"}`}
            name="nombreequipo"
            type="text"
            ...
            />
            <Item>Modelo:</Item>
            <Input className={`modelo ${editable ? "" : "disabled"}`}
            name="modelo"
            type="text"
            rows={4}
            placeholder="Modelo"
            ...
            />
            <Item>Año:</Item>
            <Input className={`ano ${editable ? "" : "disabled"}`}
            name="ano"
            type="text"
            placeholder="Año"
            value ={`${viewEquip.ano}`}
            ...
            <Input className={`Id_descripcion ${editable ? "" : "disabled"}`}
                name="Id_descripcion"
                type="text"
            ...
            <Input className={`nombre_manual ${editable ? "" : "disabled"}`}
                name="nombre_manual"
                type="text"
            ...
            <Input className={`fallo ${editable ? "" : "disabled"}`}
                name="fallo"
                type="text"
            ...
            <Input className={`Disponibilidad ${editable ? "" : "disabled"}`}
                name="Disponibilidad"
                type="text"
                placeholder="Disponibilidad"
                value ={`${viewEquip.Disponibilidad ? "Disponible":"No disponible"}`}
            />
        </Form>
